...
var PlanParser = class {
  ...
  parseStep(ctx) {
    ...
    if (action.base) {
      ...
      if (!on) {
        throw `@${ctx.i}: Upgrade '${action.upgrade}' built at ${posName} where there is no tower.`;
      }
      step.upgrade = this.towers.upgrades.find((u) => u.on === on && u.sn === action.upgrade);
      if (!step.upgrade) {
        throw `@${ctx.i}: Upgrade '${action.upgrade} is not valid on ${previous.base.ln} at ${posName}.`;
      }
      ;
...
var positions_min_default = {
  ...
  L5: { E9: { x: 1021, y: 178 }, B8: { x: 635, y: 258 }, A7: { x: 514, y: 326 }, G7: { x: 1286, y: 348 }, E7: { x: 1015, y: 378 }, G6: { x: 1348, y: 416 }, C6: { x: 770, y: 437 }, D4: { x: 964, y: 589 }, F4: { x: 1186, y: 597 }, B3: { x: 667, y: 625 }, D3: { x: 951, y: 677 }, F3: { x: 1168, y: 690 }, F1: { x: 1135, y: 795 }, B1: { x: 750, y: 840 } },
  ...
  L9: { D9: { x: 903, y: 205 }, E9: { x: 1047, y: 210 }, F9: { x: 1187, y: 216 }, B7: { x: 680, y: 371 }, C7: { x: 805, y: 411 }, D7: { x: 945, y: 411 }, E7: { x: 1085, y: 413 }, G5: { x: 1336, y: 549 }, D4: { x: 934, y: 625 }, E4: { x: 1073, y: 625 }, F4: { x: 1214, y: 625 }, G4: { x: 1356, y: 650 }, F1: { x: 1179, y: 832 }, E1: { x: 1027, y: 835 }, C1: { x: 878, y: 837 }, A1: { x: 520, y: 874 } },
  ...
  L22: { C9: { x: 730, y: 245 }, G9: { x: 1355, y: 289 }, E8: { x: 1059, y: 333 }, B8: { x: 657, y: 341 }, D8: { x: 936, y: 366 }, F8: { x: 1213, y: 366 }, H6: { x: 1421, y: 489 }, B5: { x: 602, y: 531 }, C5: { x: 805, y: 538 }, E5: { x: 1052, y: 544 }, B4: { x: 632, y: 643 }, F3: { x: 1245, y: 679 }, H3: { x: 1512, y: 693 }, D3: { x: 850, y: 695 }, F2: { x: 1125, y: 743 }, A2: { x: 445, y: 784 }, G1: { x: 1332, y: 873 }, C1: { x: 833, y: 884 } },
...
var towers_min_default = {
  ...
  upgrades: [
    ...
    { ln: "Heal", sn: "z", on: "p4", cost: [220, 150, 150], index: 2 },
