...
const WordleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wordle_free(ptr >>> 0));
/**
*/
export class Wordle {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Wordle.prototype);
        obj.__wbg_ptr = ptr;
        WordleFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WordleFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wordle_free(ptr);
    }
    /**
    * @param {string} valid
    ...
    * @returns {Wordle}
    */
    static new(valid, answers, strategy) {
        const ptr0 = passStringToWasm0(valid, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(answers, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(strategy, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wordle_new(ptr0, len0, ptr1, len1, ptr2, len2);
        return Wordle.__wrap(ret);
    }
    /**
    * @param {string} guesses
    * @param {number} simulate_game_count
    * @returns {string}
    */
    assess(guesses, simulate_game_count) {
        let deferred3_0;
        let deferred3_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(guesses, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            wasm.wordle_assess(retptr, this.__wbg_ptr, ptr0, len0, simulate_game_count);
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_2feceec6b28c2ce3 = function(arg0, arg1) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wordle_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
